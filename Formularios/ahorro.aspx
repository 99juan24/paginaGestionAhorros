<%@ Page Title="" Language="C#" MasterPageFile="~/Formularios/Principal.Master" AutoEventWireup="true" CodeBehind="ahorro.aspx.cs" Inherits="PaginaAhorro.Formularios.ahorro1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-6">
        ...
        <div class="modal-title align-content-center h3">
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:Label runat="server" Text=" MIS AHORROS" Font-Size="Larger" style="color: white;"></asp:Label>
         </div>
        <br />
        <br />
      <div class="align-items-center col-auto">
    <asp:Panel ID="Panel1" runat="server"  Width="493px">
        <asp:Label ID="Label6" runat="server" Text="Id del Ahorro: " style="color: white;" ></asp:Label>        
        <asp:TextBox ID="txtid" runat="server" Width="274px"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" Text="Descripcion del Ahorro: " style="color: white;" ></asp:Label>        
        <asp:TextBox ID="txtnombre" runat="server" Width="274px"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Text="Monto del ahorro:" style="color: white;" ></asp:Label>
        <asp:TextBox ID="txtmonto" runat="server" Width="274px"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" Text="Progreso:" style="color: white;" ></asp:Label>
        ...
        <br />
          ...
          <br />
           <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label5" runat="server" Text="Información Ahorros" CssClass="auto-style1"></asp:Label>
          <br /> 
    <asp:GridView ID="DatosAhorro" runat="server" CellPadding="4" DataSourceID="LinqDataSource1" ForeColor="#333333" GridLines="None">
    ...
    <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="paginaAhorro.Formularios.ModeloAhorrosDataContext" EntityTypeName="" Select="new (Id, descripcion, monto, fecha_creacion,fecha_limite,progreso,Estado)" TableName="ahorro" OnSelecting="LinqDataSource1_Selecting"></asp:LinqDataSource>
</asp:Content>
